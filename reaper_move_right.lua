			...
			for j=0, reaper.CountTakes(mediaItem)-1 do
				...
				for k=0, notecnt-1 do
					...
					if selected == true then
						...
						if cc16 == 127 then
							if new_pitch + 1 % 12 == 0 then
								cc19 = cc19 + 1
								cc16 = 64
							else
								cc16 = 64
								new_pitch = new_pitch + 1
							end
						else
							cc16 = cc16 + 1
						end
						...
						if cc16 ~= 64 then
							reaper.MIDI_InsertCC(take, selected, muted, startppqpos, 176, 0, 16, cc16)
						end
						if cc19 ~= 64 then
							reaper.MIDI_InsertCC(take, selected, muted, startppqpos, 176, 0, 19, cc19)
						end
						modifiedNotes = true
					end
				end
